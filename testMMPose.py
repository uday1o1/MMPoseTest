...
CFG = 'td-hm_hrnet-w48_8xb32-210e_coco-256x192.py'
...
# 3) inference
results = inference_topdown(model, IMG, bboxes=bboxes)
print(f"Instances detected: {len(results)}")
if results:
    kpts = results[0].pred_instances.keypoints  # (N, K, 2)
